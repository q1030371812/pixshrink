...
// --- Illustrations (unchanged SVG art, no copy) -----------------------------
  ...
  return (
    ...
    >
      ...
      <g transform="translate(176 88)">
        ...
        <path d="M-4 4 L4 -4" stroke="var(--color-rose)" strokeWidth="2" strokeLinecap="round" />
      </g>
    </svg>
  );
}
    ...
    >
      ...
      <g transform="translate(22 30)">
        <g transform="translate(0 0)">
          ...
          <path d="M0 30 L16 16 L26 24 L40 12 L60 28 L60 40 L0 40 Z" fill="var(--color-accent)" fillOpacity="0.16" />
          <circle cx="18" cy="12" r="3" fill="var(--color-accent)" fillOpacity="0.45" />
        </g>
        <g transform="translate(8 10)">
          <rect width="60" height="40" rx="5" fill="var(--color-surface)" stroke="var(--color-border)" />
          <path d="M0 30 L16 16 L26 24 L40 12 L60 28 L60 40 L0 40 Z" fill="var(--color-amber)" fillOpacity="0.18" />
        ...
        <g transform="translate(16 20)">
          ...
          <path d="M0 30 L16 16 L26 24 L40 12 L60 28 L60 40 L0 40 Z" fill="var(--color-accent)" fillOpacity="0.28" />
      ...
      <g transform="translate(110 30)">
        {[0, 1, 2, 3, 4].map((i) => (
          <g key={i} transform={`translate(0 ${i * 16})`}>
            ...
            <rect x="2" y="2" width={82 - i * 12} height="5" rx="2.5" fill="var(--color-accent)" fillOpacity={0.7 - i * 0.1} />
            <circle cx={82 - i * 12} cy="4.5" r="2.4" fill="var(--color-accent-strong)" />
          </g>
        ))}
      </g>
  ...
  return (
    ...
    >
      ...
      <g transform="translate(150 64)">
        ...
        <text x="30" y="13" textAnchor="middle" fontSize="9" fontWeight="700" fill="var(--color-accent-strong)" fontFamily="ui-sans-serif, system-ui">
          Quality
        </text>
      </g>
    </svg>
